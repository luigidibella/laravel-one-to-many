...
@section('content')
    ...
    <h2 class="text-white">Elenco Tecnologie</h2>
        ...
        <div class="col-6">
            ...
            <div class="my-4">
                <form action="{{ route('admin.technologies.store') }}" method="POST" class="d-flex">
                    @csrf
                    <input class="form-control me-2" type="search" placeholder="Nuova Tecnologia" name="name">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex">
                            ...
                            <form action="{{ route('admin.technologies.destroy', $item) }}" method="POST" onsubmit="return confirm('Sei sicuro di vole eliminare \'{{ $item->name }}\'?')">
                                @csrf
                                @method('DELETE')

                                <button class="btn btn-danger"><i class="fa-regular fa-trash-can"></i></button>
                            </form>
                            {{-- <a href="{{ route('admin.technologies.edit', $item->id) }}" class="btn btn-warning me-2"><i class="fa-regular fa-pen-to-square"></i></a>
                            <form
                                class="d-inline"
                                action="{{ route('admin.technologies.destroy', $item->id) }}"
                                method="POST"
